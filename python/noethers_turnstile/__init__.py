"""
Noethers Turnstile — admissibility compiler.
...
Usage::
    ...
    from noethers_turnstile import (
...
_logger = _logging.getLogger("noethers_turnstile")
...
def _log_live_permission(
    ...
    *,
    ...
    _logger.log(
        level,
        "noethers_turnstile.live_permission",
        extra={
            "permission": perm,
